...
const STORAGE_KEY = 'nautica_code_generator_history';
          ...
          <div style={{ display: 'flex', gap: '4px', background: 'var(--bg-tertiary, rgba(128,128,128,0.1))', borderRadius: '8px', padding: '3px' }}>
            <button
              ...
              style={{
                ...
                fontSize: '13px',
                fontWeight: 500,
                background: codeType === 'qr' ? 'var(--color-accent-cyan)' : 'transparent',
            ...
            <button
              ...
              style={{
                ...
                fontSize: '13px',
                fontWeight: 500,
                background: codeType === 'barcode' ? 'var(--color-accent-cyan)' : 'transparent',
